...
public class Toolchain {
    ...
    public void prepare() throws Exception {
        ...
        apktoolJar = copyAsset("engine/apktool.jar", "apktool.jar", false);
        jadxJar    = copyAsset("engine/jadx.jar", "jadx.jar", false);
        apksigJar  = copyAsset("engine/apksig.jar", "apksig.jar", false);
        keyPk8     = copyAsset("engine/testkey.pk8", "testkey.pk8", false);
        keyPem     = copyAsset("engine/testkey.x509.pem", "testkey.x509.pem", false);
        ...
        ecjJar     = copyAsset("engine/ecj.jar", "ecj.jar", false);
        d8Jar      = copyAsset("engine/d8.jar", "d8.jar", false);
        androidJar = copyAsset("engine/android.jar", "android.jar", false);
